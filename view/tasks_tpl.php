    ...
    <div class="row">
      <?php
        foreach($tasks as $task){
            ...
            echo '<div class="panel-heading"><span class="title-task">' . $task->title . ' (создана: ' . $task->create_date . ')</span> 
                  <span class="btn-delete"><a class="btn btn-default" href="#">удалить</a></span>
                  </div>';
            echo '<div class="panel-body">' . $task->task . '</div>';
            echo '<div class="panel-footer"> Выполнить: ' . $task->exp_date . '</div>';
            echo '</div>';
            }
      ?>
    </div>
